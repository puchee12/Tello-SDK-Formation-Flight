...
def droneState(streamingClient):
...
def waypointGeneration(streamingClient):
	...
	start_position = droneState(streamingClient)[1][0,:]	# of tello
	...
	# Put Waypoint 1 here
	waypoint[1] = waypoint[0] + np.array([0, 100, 0])

	# Put Waypoint 2 here
	waypoint[2] = waypoint[1] + np.array([-100, 0, 0])

	# Put Waypoint 3 here
	waypoint[3] = waypoint[2] + np.array([0, -100, 0])

	# Put Waypoint 1 here
	# waypoint[4] = waypoint[0] + np.array([100, 100, 0])
	#
	# # Put Waypoint 2 here

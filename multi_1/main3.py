...
from position3 import (startTracking, trueState, waypointGeneration,
        waypointUpdate)
...
if optitrack:
    ...
    streamingClient = startTracking(3, 3)	# Get rigid body ID from Motive (4, 3)
